...
this.forceUpdate();
  ...
  winGame = () => {
   if( (itemContainer[0] !== "empty") && (itemContainer[0] == itemContainer[1]) && 
  ( itemContainer[1] == itemContainer[2]) )
   {
    this.setState({
...
else if( (itemContainer[3] !== "empty") && (itemContainer[3] == itemContainer[4]) && 
...
else if( (itemContainer[6] !== "empty") && (itemContainer[6] == itemContainer[7]) && 
( itemContainer[7] == itemContainer[8]) )
 {
  this.setState({
    winMessage : (itemContainer[6] ? "Cross" : "Circle").concat("Won")
})
 }
else if( (itemContainer[0] !== "empty") && (itemContainer[0] == itemContainer[4]) && 
( itemContainer[4] == itemContainer[8]) )
 {
  this.setState({
    winMessage : (itemContainer[0] ? "Cross" : "Circle").concat("Won")
})
 ...
 else if( (itemContainer[2] !== "empty") && (itemContainer[2] == itemContainer[4]) && 
 ( itemContainer[4] == itemContainer[6]) )
  {
   this.setState({
  ...
  else if( (itemContainer[0] !== "empty") && (itemContainer[0] == itemContainer[3]) && 
  ( itemContainer[3] == itemContainer[6]) )
   {
    this.setState({
      winMessage : (itemContainer[0] ? "Cross" : "Circle").concat("Won")
  })
   ...
   else if( (itemContainer[1] !== "empty") && (itemContainer[1] == itemContainer[4]) && 
   ( itemContainer[4] == itemContainer[7]) )
    {
     this.setState({
  ...
  else if( (itemContainer[2] !== "empty") && (itemContainer[2] == itemContainer[5]) && 
  ( itemContainer[5] == itemContainer[8]) )
   {
    this.setState({
      winMessage : (itemContainer[2] ? "Cross" : "Circle").concat("Won")
  })
  ...
  return (
    <View style={ styles.container }>
        <View style= {styles.grid}>
            ...
            <Button full rounded primary style={styles.button} onPress={this.resetGame} title="reset"/>
        </View>
    </View>
  );
}
